...
const BROWSERS: [&'static str; 117] = [
    ...
    "Browzar", "Camino", "Charon", "Cheshire", "Chimera", "Chrome", "ChromePlus", "Classilla", "CometBird", "Comodo_Dragon",
    "Conkeror", "Crazy+Browser", "Cyberdog", "Deepnet+Explorer", "DeskBrowse", "Dillo", "Dooble", "Edge", "Element+Browser",
    "Elinks", "Enigma+Browser", "EnigmaFox", "Epiphany", "Escape", "Firebird", "Firefox", "Fireweb+Navigator", "Flock", "Fluid",
    "Galaxy", "Galeon", "GranParadiso", "GreenBrowser", "Hana", "HotJava", "IBM+WebExplorer", "IBrowse", "iCab", "Iceape",
    "IceCat", "Iceweasel", "iNet+Browser", "Internet+Explorer", "iRider", "Iron", "K-Meleon", "K-Ninja", "Kapiko", "Kazehakase",
    "Kindle+Browser", "KKman", "KMLite", "Konqueror", "LeechCraft", "Links", "Lobo", "lolifox", "Lorentz", "Lunascape", "Lynx",
    "Madfox", "Maxthon", "Midori", "Minefield", "Mozilla", "myibrow", "MyIE2", "Namoroka", "Navscape", "NCSA_Mosaic", "NetNewsWire",
    "NetPositive", "Netscape", "NetSurf", "OmniWeb", "Opera", "Orca", "Oregano", "osb-browser", "Palemoon", "Phoenix", "Pogo",
    "Prism", "QtWeb+Internet+Browser", "Rekonq", "retawq", "RockMelt", "Safari", "SeaMonkey", "Shiira", "Shiretoko", "Sleipnir",
    "SlimBrowser", "Stainless", "Sundance", "Sunrise", "surf", "Sylera", "Tencent+Traveler", "TenFourFox", "theWorld+Browser",
    "uzbl", "Vimprobable", "Vonkeror", "w3m", "WeltweitimnetzBrowser", "WorldWideWeb", "Wyzo"
];
...
impl<'a> Browsers<'a> {
    ...
    set_unset!(self, set_america_online_browser, unset_america_online_browser, "America+Online+Browser");
    ...
    set_unset!(self, set_avant_browser, unset_avant_browser, "Avant+Browser");
    ...
    set_unset!(self, set_comodo_dragon, unset_comodo_dragon, "Comodo_Dragon");
    set_unset!(self, set_conkeror, unset_conkeror, "Conkeror");
    set_unset!(self, set_crazy_browser, unset_crazy_browser, "Crazy+Browser");
    set_unset!(self, set_cyberdog, unset_cyberdog, "Cyberdog");
    set_unset!(self, set_deepnet_explorer, unset_deepnet_explorer, "Deepnet+Explorer");
    ...
    set_unset!(self, set_element_browser, unset_element_browser, "Element+Browser");
    set_unset!(self, set_elinks, unset_elinks, "Elinks");
    set_unset!(self, set_enigma_browser, unset_enigma_browser, "Enigma+Browser");
    ...
    set_unset!(self, set_fireweb_navigator, unset_fireweb_navigator, "Fireweb+Navigator");
    ...
    set_unset!(self, set_ibm_web_explorer, unset_ibm_web_explorer, "IBM+WebExplorer");
    ...
    set_unset!(self, set_internet_explorer, unset_internet_explorer, "Internet+Explorer");
    ...
    set_unset!(self, set_kindle_browser, unset_kindle_browser, "Kindle+Browser");
    ...
    set_unset!(self, set_qt_web_internet_browser, unset_qt_web_internet_browser, "QtWeb+Internet+Browser");
    ...
    set_unset!(self, set_tecent_traveler, unset_tecent_traveler, "Tencent+Traveler");
    set_unset!(self, set_ten_four_fox, unset_ten_four_fox, "TenFourFox");
    set_unset!(self, set_the_world_browser, unset_the_world_browser, "theWorld+Browser");
    ...
    set_unset!(self, set_weltweitimnetz_browser, unset_weltweitimnetz_browser, "WeltweitimnetzBrowser");
    set_unset!(self, set_world_wide_web, unset_world_wide_web, "WorldWideWeb");
